...
def header_page():
    st.markdown("<h1 style='text-align: center; color: red;'>Analysis of PMFBY Data 2018-2023</h1>", unsafe_allow_html=True)
...
def Taluka_Wise_Analysis():
    ...
    st.sidebar.header("Please Select the Year and District:")
